...
public:
    ...
    void WriteInBinFile(Student tempStudent, ofstream &outfile, int &sizeTask)
    {
        ...
        outfile.write(reinterpret_cast<char *>(&tempStudent), sizeof(Student));
        sizeTask++;
    }
};
...
int main()
{
    ...
    while (true)
    {
        ...
        case 1:
        {
            ...
            ofstream out("/Users/pavelbelanov/Desktop/task_1_3/task_1_3/AllStudents.bin", ios::binary | ios::app);
        ...
        case 2:
        {
            ifstream infile("/Users/pavelbelanov/Desktop/task_1_3/task_1_3/AllStudents.bin", ios::binary);
        ...
        case 3:
        {
            ...
            ifstream infile("/Users/pavelbelanov/Desktop/task_1_3/task_1_3/AllStudents.bin", ios::binary);
            ofstream out("/Users/pavelbelanov/Desktop/task_1_3/task_1_3/OldestStudents.bin", ios::binary | ios::app);
        ...
        case 4:
        {
            ifstream infile("/Users/pavelbelanov/Desktop/task_1_3/task_1_3/OldestStudents.bin", ios::binary);
